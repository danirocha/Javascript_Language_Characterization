...
//		creator.createFile(DIRETORIO, bibliotecas, bibliotecasRejeitar);
	...
	private static void searchDirectory(List<Biblioteca> bibliotecas, BufferedWriter bwLog, BufferedWriter bw) throws IOException {
...
//				continue;
			...
			String caminho = "C:\\Users\\luisb\\Documents\\ColetaDadosJavascript\\dist\\" + numeroPasta + "\\" + pasta;
			...
			if(file.exists())
				if(file.isDirectory())
				{
					...
					bwLog.write(biblioteca.getNome() + "\n");
					numeroBibliotecas++;
				}			
		}
